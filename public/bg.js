...
function initParticle(i) {
  ...
  x = rand(canvas.a.width * 2) - canvas.a.width / 2;
  y = rand(canvas.a.height * 2) - canvas.a.height / 2;
...
function drawParticle(x, y, theta, life, ttl, size, hue) {
  ...
  ctx.a.lineCap = "round";
  ctx.a.lineWidth = 1;
  ctx.a.fillStyle = `hsla(${hue},0%,60%,${Math.min(fadeInOut(life, ttl), 0.2)})`;
  ctx.a.beginPath();
  ctx.a.translate(xRel, yRel);
  ctx.a.rotate(theta);
  ctx.a.translate(-xRel, -yRel);
  ctx.a.fillRect(xRel, yRel, size, size / 4);
  ctx.a.closePath();
  ctx.a.restore();
}
...
function render() {
  ctx.b.save();
  ctx.b.globalCompositeOperation = "darker";
  ctx.b.drawImage(canvas.a, 0, 0);
  ctx.b.restore();
}
